...
import fs from "fs";
import os from "os";
import { API2Love, API2LoveConfig } from "../API2Love";
...
export class DocGenerator {
    ...
    private static _generateResponseSchema(type: Type, apiSpec: OpenAPIObject, program: TJS.Program, config: API2LoveConfig): ResponsesObject {
